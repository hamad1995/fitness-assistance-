...
echo "<script>alert('Something went wrong. Please try again');</script>";
 echo "<script type='text/javascript'> document.location = 'offer-listing.php'; </script>";
} }  else{
...
<title>Fitness Assistance | Offers Details</title>
<!--Bootstrap -->
...
$sql = "SELECT tbloffers.*,tblbranches.BrandName,tblbranches.id as bid  from tbloffers join tblbranches on tblbranches.id=tbloffers.VehiclesBrand where tbloffers.id=:vhid";
$query = $dbh -> prepare($sql);
$query->bindParam(':vhid',$vhid, PDO::PARAM_STR);
$query->execute();
        ...
        <div class="listing_more_info">
          <div class="listing_detail_wrap"> 
            ...
            <ul class="nav nav-tabs gray-bg" role="tablist">
              ...
              <li role="presentation"><a href="#accessories" aria-controls="accessories" role="tab" data-toggle="tab">Equipment</a></li>
            </ul>
...
<?php 
$bid=$_SESSION['brndid'];
$sql="SELECT tbloffers.VehiclesTitle,tblbranches.BrandName,tbloffers.PricePerDay,tbloffers.FuelType,tbloffers.ModelYear,tbloffers.id,tbloffers.SeatingCapacity,tbloffers.VehiclesOverview,tbloffers.Vimage1 from tbloffers join tblbranches on tblbranches.id=tbloffers.VehiclesBrand where tbloffers.VehiclesBrand=:bid";
$query = $dbh -> prepare($sql);
...
{ ?>      
        <div class="col-md-3 grid_listing">
          <div class="product-listing-m gray-bg">
            <div class="product-listing-img"> <a href="offer-details.php?vhid=<?php echo htmlentities($result->id);?>"><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" class="img-responsive" alt="image" /> </a>
            </div>
            <div class="product-listing-content">
              ...
              <p class="list-price">SR <?php echo htmlentities($result->PricePerDay);?></p>
