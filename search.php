...
<title>Fitness Assitance | Offer Listing</title>
<!--Bootstrap -->
...
<!-- Fav and touch icons -->
<link rel="apple-touch-icon-precomposed" sizes="144x144" href="assets/images/banner-image.jpg">
...
$sql = "SELECT tbloffers.id from tbloffers 
join tblbranches on tblbranches.id=tbloffers.VehiclesBrand 
where tbloffers.VehiclesTitle=:search || tbloffers.FuelType=:search || tblbranches.BrandName=:search || tbloffers.ModelYear=:search";
...
<?php 
$sql = "SELECT tbloffers.*,tblbranches.BrandName,tblbranches.id as bid  from tbloffers 
join tblbranches on tblbranches.id=tbloffers.VehiclesBrand 
where tbloffers.VehiclesTitle=:search || tbloffers.FuelType=:search || tblbranches.BrandName=:search || tbloffers.ModelYear=:search";
$query = $dbh -> prepare($sql);
$query -> bindParam(':search',$searchdata, PDO::PARAM_STR);
