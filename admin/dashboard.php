...
<head>
	...
	<title>Fitness Assistance | Admin Dashboard</title>
...
?>
													...
													<div class="stat-panel-title text-uppercase">Listed Offers</div>
												</div>
											</div>
											<a href="manage-offers.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-warning text-light">
												<div class="stat-panel text-center">
<?php 
$sql3 ="SELECT id from tblbranches ";
...
?>												
													...
													<div class="stat-panel-title text-uppercase">Listed Branchs</div>
												</div>
											</div>
