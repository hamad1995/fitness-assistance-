...
$sql="update tbloffers set Vimage2=:vimage where id=:id";
...
<head>
	...
	<title>Fitness Assistance | Admin Update Image 2</title>
...
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage2 from tbloffers where tbloffers.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
