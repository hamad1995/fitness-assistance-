...
$sql="update tbloffers set Vimage4=:vimage where id=:id";
...
<head>
	...
	<title>Fitness Assistance | Admin Update Image 4</title>
...
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage4 from tbloffers where tbloffers.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
