...
$sql="update tbloffers set Vimage1=:vimage1 where id=:id";
...
<head>
	...
	<title>Fitness Assistance | Admin Update Image 1</title>
...
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage1 from tbloffers where tbloffers.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
