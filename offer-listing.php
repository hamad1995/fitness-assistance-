...
<?php $sql = "SELECT tbloffers.*,tblbranches.BrandName,tblbranches.id as bid  from tbloffers join tblbranches on tblbranches.id=tbloffers.VehiclesBrand";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
...
<?php }} ?>
              ...
              <div class="form-group">
                <button type="submit" class="btn btn-block"><i class="fa fa-search" aria-hidden="true"></i> Search Offer</button>
              </div>
            </form>
          </div>
        </div>
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-heartbeat" aria-hidden="true"></i> Most Wanted Offer</h5>
          </div>
          <div class="recent_addedcars">
            <ul>
<?php $sql = "SELECT tbloffers.*,tblbrandches.BrandName,tblbranches.id as bid  from tbloffers join tblbranches on tblbranches.id=tbloffers.VehiclesBrand order by id desc limit 4";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
